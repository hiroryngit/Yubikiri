...
IMPORTANT: The content field may contain HTML markup (e.g. <p>, <strong>, <em>, <h1>, <ul>, <li>, <span style="...">, <mark>, <a href="...">, etc.). You MUST preserve ALL HTML tags and attributes exactly as they are. Do NOT modify, remove, or add any HTML tags or attributes. Do NOT translate attribute values like href URLs, style properties, or class names. Only translate the visible text content. When translating, adjust the POSITION of inline formatting tags (such as <strong>, <em>, <mark>, <span>, <u>, <s>) so that they wrap the semantically equivalent words/phrases in the target language. Since word order differs across languages, the tags should move to natural positions in the translated sentence rather than staying in the original position. For example: "Please <mark>sign here</mark> to confirm" → "確認のため<mark>ここに署名</mark>してください". The key rule: keep all tags and attributes intact, but reposition inline tags to match the target language's grammar and word order.
